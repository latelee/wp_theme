...
?>
<script type="text/javascript" src="https://raw.githubusercontent.com/weisay/theme/master/weisaysimple_latest_version.js"></script>
...
<h2><?php echo $themename; ?> 设置</h2>
	<div class="version_tips"><span class="vright close_version_tips">关闭</span>Weisay Simple 新版本 <span class="version_number"></span> 可用。<a href="" class="downloand_add">点击这里</a> 下载最新版本 或 <a href="" class="author_add" target="_blank">访问此主题更新页面</a></div><div class="clearfix"></div>
...
function mytheme_wp_head() { 
	...
	if($stylesheet != ''){?>
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory'); ?>/css/<?php echo $stylesheet; ?>?ver=1.62" />
<?php }
} 
