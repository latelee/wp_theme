...
<div class="article">
    <div class="article_info">作者：<?php the_author() ?> &nbsp; 发布：<?php the_time('Y-m-d H:i') ?> &nbsp; 分类：<?php the_category(', ') ?> &nbsp; <?php if(function_exists('the_views')) { echo '阅读：'; the_views(); } ?> &nbsp; <?php comments_popup_link ('无评论','1条评论','%条评论'); ?> &nbsp; <?php edit_post_link('编辑', ' [ ', ' ] '); ?></div><div class="clear"></div>
            <div class="context">
